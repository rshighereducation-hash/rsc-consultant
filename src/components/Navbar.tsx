        ...
        <div className="flex items-center justify-between gap-2 sm:gap-4">
                          ...
                          <div className="flex items-center gap-2.5">
                            ...
                            <div>
                              ...
                              <p className="text-[11px] text-slate-500">
                                Comprehensive admissions and student visa
                                guidance for Pakistani students
                              </p>
                            </div>
                          </div>
                          <button
                        ...
                        <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between bg-red-50/50 -mx-6 -mb-6 p-4 rounded-b-3xl">
                          <div className="flex items-center gap-2 text-xs text-slate-700">
                            ...
                            <span className="font-semibold">
                              Unsure which country matches your budget &amp;
                              qualifications?
                            </span>
                          </div>
                          <button
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            ...
            <button
              ...
              {mobileMenuOpen ? (
                <X className="w-5 h-5 text-[#DB0303]" />
              ) : (
