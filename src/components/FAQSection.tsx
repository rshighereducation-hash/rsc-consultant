...
export const FAQSection: React.FC = () => {
  ...
  return (
    <section
      id="faq-section"
      className="py-20 bg-gradient-to-b from-white via-red-50/20 to-white relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-slate-600 text-base sm:text-lg max-w-2xl mx-auto">
            Clear, transparent guidance on admissions, visa approvals, bank
            statements, and scholarship opportunities for Pakistani scholars.
          </p>
        </div>
        ...
        <div
          ...
          <div className="relative w-full aspect-[16/9] sm:aspect-[21/9] max-h-[380px] min-h-[240px] flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute top-4 left-4 sm:top-5 sm:left-5 z-20 flex items-center gap-2.5 px-3 sm:px-3.5 py-1.5 rounded-2xl bg-slate-950/85 backdrop-blur-md border border-white/20 shadow-xl">
            ...
            <div className="absolute inset-x-0 bottom-0 p-5 sm:p-7 text-white z-20 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
              <div className="space-y-1.5 max-w-xl">
                ...
                <p className="text-xs sm:text-sm text-slate-200 font-normal leading-relaxed">
                  Every answer below is backed by authentic firsthand experience
                  in UK and global higher education admissions, visas, and
                  university life.
                </p>
              </div>
              ...
              <div className="flex items-center gap-2 shrink-0">
                <div className="px-3 py-1.5 rounded-xl bg-white/10 backdrop-blur-md border border-white/15 text-center">
                  <div className="text-xs font-black text-amber-400 font-heading">
                    100%
                  </div>
                ...
                <div className="px-3 py-1.5 rounded-xl bg-white/10 backdrop-blur-md border border-white/15 text-center">
                  <div className="text-xs font-black text-emerald-400 font-heading">
                    Zero
                  </div>
                  <div className="text-[9px] text-slate-300 font-medium">
                    Hidden Charges
            ...
            return (
              <div
                ...
                className={`bg-white border rounded-3xl overflow-hidden transition-all duration-200 shadow-xs ${
                  isOpen
                    ? "border-red-200 shadow-md shadow-red-950/5 ring-1 ring-red-100"
                ...
                <button
                  ...
                  <div
                    className={`p-2 rounded-xl shrink-0 transition-colors ${isOpen ? "bg-red-50 text-[#DB0303]" : "bg-slate-100 text-slate-500"}`}>
                    {isOpen ? (
        ...
        <div className="mt-8 p-6 sm:p-8 bg-white rounded-3xl border border-red-100 shadow-lg shadow-red-950/5 text-center space-y-3">
          <p className="text-sm text-slate-700 font-bold font-heading">
            Still have a specific question about your degree equivalence,
            university sponsor, or bank requirements?
          </p>
          <a
