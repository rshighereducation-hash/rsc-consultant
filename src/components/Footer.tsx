...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer
      id="site-footer"
      className="bg-slate-50 text-slate-700 border-t border-slate-200 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="lg:col-span-4 space-y-5">
            <div className="flex flex-wrap items-center gap-3">
              <button
                ...
                <img
                  src={logo}
                  className="w-[60%] sm:w-[50%] md:w-[40%] lg:w-[30%] xl:w-[30%] 2xl:w-[30%] h-auto"
                  alt="footer-logo"
                />
              </button>
            ...
            <p className="text-xs text-slate-600 leading-relaxed font-medium">
              <strong>RS Higher Education Consultants</strong> provides ethical,
              student-centered admissions and visa consultancy for Pakistani
              students across 16 leading study destinations worldwide.
            </p>
            ...
            <div className="space-y-2.5 text-xs text-slate-600">
              <div className="flex items-start gap-2.5">
                ...
                <a
                  href={
                    BUSINESS_INFO.address.mapsUrl ||
                    "https://maps.app.goo.gl/AZ8Gwq6PdELtw6fR6?g_st=aw"
                  }
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-[#DB0303] transition-colors">
                  {BUSINESS_INFO.address.office},{" "}
                  {BUSINESS_INFO.address.building}, {BUSINESS_INFO.address.road}
                  , {BUSINESS_INFO.address.city}, Pakistan
                </a>
              </div>
              <div className="flex items-center gap-2.5">
                ...
                <a
                  ...
                  className="hover:text-[#DB0303] font-bold text-slate-800 transition-colors">
                  {BUSINESS_INFO.phone}
                </a>
              </div>
              <div className="flex items-center gap-2.5">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-2.5">
              ...
              <a
                href={
                  ...
                  "https://www.instagram.com/rshighereducation/"
                }
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="pt-8 border-t border-slate-200 text-xs text-slate-500 leading-relaxed space-y-2">
          <p>
            ...
            RS Higher Education Consultants is an educational advisory and
            student placement consultancy headquartered in Peshawar, Pakistan.
            RS Higher Education Consultants is not a government agency, embassy,
            or high commission. Admissions decisions rest exclusively with
            individual academic institutions, and visa issuance is the sole
            legal sovereign prerogative of the respective government embassies
            and immigration authorities. RS provides genuine profile auditing,
            document compilation assistance, and verified application
            facilitation.
          </p>
        </div>
        ...
        <div className="pt-6 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <p>
            © {new Date().getFullYear()} RS Higher Education Consultants. All
            rights reserved. Peshawar, Pakistan.
          </p>
